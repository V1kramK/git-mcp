# Git Mcp API MCP Server

This MCP (Model Content Protocol) server provides access to Git Mcp API API functionality through HTTP, HTTPS, and STDIO transport modes.
